...
class MovementSystemTest {
  ...
  void testMovementSystem_updatesPositionCorrectly() {
    ...
    assertEquals(
        ...
        0.001f,
        "X position should be updated correctly for diagonal movement.");
    assertEquals(
        expected,
        transform.position.y,
        0.001f,
        "Y position should be updated correctly for diagonal movement.");
  ...
  void testMovementSystem_noMovementWhenNotControlled() {
    ...
    assertEquals(
        new Vector3f(0, 0, 0),
        transform.position,
        "Position should not change when there is no input.");
  }
