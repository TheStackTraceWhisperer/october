...
class SoundEffectComponentTest {
  ...
  void constructor_shouldSetRequiredFieldsAndDefaults() {
    SoundEffectComponent sound =
        new SoundEffectComponent("explosion_sound", TestSoundEffectType.EXPLOSION);
  ...
  void hasBeenTriggered_defaultsToFalse() {
    SoundEffectComponent sound =
        new SoundEffectComponent("test_sound", TestSoundEffectType.COLLECT);
