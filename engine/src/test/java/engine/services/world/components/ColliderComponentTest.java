...
class ColliderComponentTest {
  ...
  void constructor_shouldAcceptNegativeOffsets() {
    ColliderComponent collider = new ColliderComponent(TestColliderType.PLAYER, 32, 32, -5, -10);
  ...
  void constructor_shouldAcceptZeroDimensions() {
    ...
    ColliderComponent collider = new ColliderComponent(TestColliderType.WALL, 0, 0, 0, 0);
  ...
  void constructor_shouldAcceptVariousDimensions() {
    ColliderComponent smallCollider =
        new ColliderComponent(TestColliderType.PROJECTILE, 8, 8, 0, 0);
    ColliderComponent largeCollider =
        new ColliderComponent(TestColliderType.ENEMY, 128, 256, 10, 20);
  ...
  void getters_shouldReturnCorrectValues() {
    ColliderComponent collider = new ColliderComponent(TestColliderType.PLAYER, 48, 64, -8, -16);
