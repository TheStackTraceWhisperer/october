...
class SpriteComponentTest {
  ...
  void constructor_shouldThrowExceptionWhenTextureHandleIsNull() {
    ...
    assertThrows(
        ...
        () -> new SpriteComponent(null, new Vector4f(1.0f, 1.0f, 1.0f, 1.0f)));
  }
  ...
  void equals_shouldReturnTrueForIdenticalSprites() {
    ...
    SpriteComponent sprite2 =
        new SpriteComponent("test_texture", new Vector4f(0.5f, 0.5f, 0.5f, 1.0f));
  ...
  void equals_shouldReturnFalseForDifferentColors() {
    SpriteComponent sprite1 =
        new SpriteComponent("test_texture", new Vector4f(1.0f, 0.0f, 0.0f, 1.0f));
    SpriteComponent sprite2 =
        new SpriteComponent("test_texture", new Vector4f(0.0f, 1.0f, 0.0f, 1.0f));
