...
class UIButtonComponentTest {
  ...
  void constructor_shouldUseDefaultColorsWhenNullProvided() {
    UIButtonComponent button =
        new UIButtonComponent(
            "TEST_ACTION", "normal.png", "hover.png", "pressed.png", null, null, null);
  ...
  void constructor_shouldAllowPartialNullColors() {
    ...
    UIButtonComponent button =
        new UIButtonComponent(
            "ACTION", "normal.png", "hover.png", "pressed.png", customNormal, null, null);
  ...
  void buttonState_shouldDefaultToNormal() {
    UIButtonComponent button =
        new UIButtonComponent("ACTION", "normal.png", "hover.png", "pressed.png", null, null, null);
  ...
  void constructor_shouldAcceptNullActionEvent() {
    UIButtonComponent button =
        new UIButtonComponent(null, "normal.png", "hover.png", "pressed.png", null, null, null);
  ...
  void constructor_shouldAcceptNullTextureHandles() {
    UIButtonComponent button = new UIButtonComponent("ACTION", null, null, null, null, null, null);
