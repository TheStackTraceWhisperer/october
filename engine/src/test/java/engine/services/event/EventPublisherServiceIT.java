...
public class EventPublisherServiceIT {
  ...
  @Inject private EventPublisherService eventPublisherService;

  @Inject private TestEventListener testEventListener;
  ...
  void testPublishAndSubscribe() {
    ...
    assertEquals(
        testMessage,
        testEventListener.getReceivedMessage(),
        "The listener should have received the correct event message.");
  }
}
